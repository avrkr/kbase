    ...
    <div className="max-w-md mx-auto mt-10">
      <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Enter your email to receive a verification code</p>
        </div>
        ...
        <div className="mt-6 flex items-center justify-between text-sm">
          <Link to="/login" className="text-slate-500 hover:text-slate-800 flex items-center gap-1 transition-colors">
            <ArrowLeft size={14} /> Back to Login
          </Link>
          <Link to="/verify-otp" className="text-primary-600 font-medium hover:text-primary-700 transition-colors">
            Have an OTP? Verify here
          </Link>
        </div>
      </div>
    </div>
